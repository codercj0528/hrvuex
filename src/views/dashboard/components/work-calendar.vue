...
<style lang="scss" scoped>
 ...
 .el-calendar-day ::v-deep {
  height:  auto;
 }
  .el-calendar-table__row td::v-deep, .el-calendar-table tr td:first-child::v-deep,  .el-calendar-table__row td.prev::v-deep {
  border:none;
 }
.date-content {
  height: 40px;
...
.date-content .text{
 ...
 .el-calendar-table td.is-selected .text::v-deep{
   background: #409eff;
   color: #fff;
   border-radius: 50%;
 }

.el-calendar__header::v-deep {
   display: none
 }
</style>
