<template>
  <div class="dashboard-container">
    ...
    <el-dialog :visible="showDialog" title="离职申请" @close="btnCanenl">
      <el-form ref="ruleForm" label-width="120px" :model="ruleForm" :rules="rules">
        ...
        <el-form-item label="离职原因" prop="reason">
          <el-input v-model="ruleForm.reason" type="textarea" style="width: 70%;" :rows="3" />
        </el-form-item>
      </el-form>
      <el-row slot="footer" type="flex" justify="center">
        <el-col :span="6">
          <el-button size="small" type="primary" @click="btnOk">确定</el-button>
          <el-button size="small" @click="btnCanenl">取消</el-button>
        </el-col>
      </el-row>
    </el-dialog>
  </div>
...
import Rardar from './components/radar.vue'
export default {
  name: 'Dashboard',
  components: {
    WorkCalendar,
